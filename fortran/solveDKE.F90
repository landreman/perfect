...
subroutine solveDKE()
  ...
  PetscScalar, dimension(:), allocatable :: psiWeights, diagonalOfXDot, sourceThetaPart
  ...
  PetscScalar, dimension(:), allocatable :: x2, thetaPartOfMirrorTerm
  ...
  PetscScalar :: VPrime, dtheta, xMaxNotTooSmall, T32
  ...
  PetscScalar, dimension(:), allocatable :: erfs, xb, expx2, expxb2, Psi_Chandra
  ...
  integer :: localNpsiInterior, sourceToUse, rowIndex, colIndex
  ...
  DM :: myDM
  integer :: ipsiMin, ipsiMax, localNpsi, ipsiMinForThisTheta, ipsiMaxForThisTheta, NpsiToUse
  ...
  logical :: procThatHandlesLeftBoundary, procThatHandlesRightBoundary, makeLocalApproximationOriginal
