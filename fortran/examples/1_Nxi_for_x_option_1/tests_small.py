...
numFailures += shouldBe("run  1/FSABFlow[0,1;;;]", 12.5481, desiredRelativeTolerance)
numFailures += shouldBe("run  1/densityPerturbation[2,1,0;;;]", -0.00148882, desiredRelativeTolerance)
