...
numFailures += shouldBe("run  1/flow[16,7,1;;;]", 13.3425, desiredRelativeTolerance)
numFailures += shouldBe("run  1/poloidalFlow[7,2,0;;;]", 0.0409016, desiredRelativeTolerance)
