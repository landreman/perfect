...
numFailures += shouldBe("run  1/poloidalFlow[7,2,0;;;]", 0.0411661, desiredRelativeTolerance)
numFailures += shouldBe("run  1/poloidalFlow[24,8,1;;;]", -3.41472, desiredRelativeTolerance)
numFailures += shouldBe("run  1/toroidalFlow[0,9,0;;;]", 17.5131, desiredRelativeTolerance)
