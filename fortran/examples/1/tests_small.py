...
numFailures += shouldBe("run  1/poloidalFlow[7,2,0;;;]", -0.157744, desiredRelativeTolerance)
numFailures += shouldBe("run  1/poloidalFlow[24,8,1;;;]", -3.42133, desiredRelativeTolerance)
numFailures += shouldBe("run  1/toroidalFlow[0,9,0;;;]", 17.5137, desiredRelativeTolerance)
