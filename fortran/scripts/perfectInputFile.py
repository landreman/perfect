...
class perfectInput(object):
    ...
    boundaryScheme = property(groupGetter('physicsParameters','boundaryScheme'), groupSetter('physicsParameters','boundaryScheme'))
    ...
    Nx = property(groupGetter('resolutionParameters','Nx'), groupSetter('resolutionParameters','Nx'))
    NL = property(groupGetter('resolutionParameters','NL'), groupSetter('resolutionParameters','NL'))
